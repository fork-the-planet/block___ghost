  ...
  return (
    <SectionWrapper>
      <AnimatedPageHeader
        kicker="ghost-map"
        title="Topology"
        description="The navigation card Ghost uses during scan and fleet workflows. map.md answers “where is the design system, which folders matter?” — language-agnostic, validated against ghost.map/v1, written by the host agent from the raw inventory."
      />
