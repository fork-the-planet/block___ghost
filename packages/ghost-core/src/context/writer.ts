...
**Feedback loop:** ask your host agent to review the generated output against this \`fingerprint.md\` (the \`review\` recipe, installed via \`ghost emit skill\`). Drift signals whether the generator honored the system.
`;
}
