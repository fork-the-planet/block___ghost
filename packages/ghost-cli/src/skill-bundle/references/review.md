...
- `ghost ack` — "yes, the current fingerprint no longer matches reality; accept drift across the board and record it."
- `ghost diverge <dimension> --reason "..."` — "this dimension is intentionally different; stop flagging it."
- `ghost adopt <parent.md>` — "adopt a new parent baseline."
