...
import { layoutFingerprint } from "../../src/core/layout.js";
...
`;
  ...
  it("matches structural expectations against the ghost-ui fixture fingerprint", async () => {
    const path = resolve(
      here,
      "../fixtures/ghost-ui-fingerprint/fingerprint.md",
    );
